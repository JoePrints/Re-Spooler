...
//ANET Model Settings
  ...
  #define Z_MIN_PROBE_ENDSTOP_INVERTING true
      ...
      #define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, TITAN_EXTRUDER_STEPS }
		    ...
		    #define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, CUSTOM_ESTEPS_VALUE }
	    #else
        #define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 138 } //jp
      #endif
	  #endif
	#else
	  #if ENABLED(TITAN_EXTRUDER)
      #define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 80, 400, TITAN_EXTRUDER_STEPS }
	  #else
	    #if ENABLED(CUSTOM_ESTEPS)
		    #define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 80, 400, CUSTOM_ESTEPS_VALUE }
	    #else
        #define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 80, 400, 93 }
	    #endif
	  #endif
  #endif
  #define DEFAULT_MAX_FEEDRATE          { 5000, 500, 100, 50 }
  #define DEFAULT_MAX_ACCELERATION      { 1700, 1700, 100, 5000 }
 ...
 // #define X_MAX_POS 5000000000
  //#define Y_MAX_POS Y_BED_SIZE
    ...
    #define X_BED_SIZE 5000000000
    #define Y_BED_SIZE 5000000000
    #define Z_MAX_POS 2300
 
    #if ENABLED(ANET_OEM)
      #define X_PROBE_OFFSET_FROM_EXTRUDER -38 //jp
...
//Misc Settings
    ...
    #define CUSTOM_MACHINE_NAME USER_PRINTER_NAME
      ...
      #define CUSTOM_MACHINE_NAME "spool winder"
